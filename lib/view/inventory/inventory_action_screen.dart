...
class InventoryActionScreen extends StatefulWidget {
  const InventoryActionScreen({Key? key}) : super(key: key);

  @override
  State<InventoryActionScreen> createState() => _InventoryActionScreenState();
}
                                ...
                                Container(
                                  child: Column(
                                    ...
                                    children: [
                                      InkWell(
                                        onTap: (){
                                          Navigator.pushNamed(context, RoutesName.inventoryNewPostiog);
                                        },
                                        child: Container(
